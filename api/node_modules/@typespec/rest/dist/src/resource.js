import { $invisible, $removeVisibility, $visibility, getKeyName, getTypeName, isErrorType, isKey, setTypeSpecNamespace, } from "@typespec/compiler";
 ...
 */
setParentResource,] = useStateMap(createStateSymbol("parentResourceTypes"));
/**
 ...
 */
export const $parentResource = (context, entity, parentType) => {
    const { program } = context;
...
function checkCircularParentResource(program, entity, parentType) {
