export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "circular-parent-resource": {
        readonly default: import("@typespec/compiler").CallableMessage<["cycle"]>;
    };
}, Record<string, any>, never>;
export declare const reportDiagnostic: <C extends "not-key-type" | "resource-missing-key" | "resource-missing-error" | "duplicate-key" | "duplicate-parent-key" | "invalid-action-name" | "shared-route-unspecified-action-name" | "circular-parent-resource", M extends keyof {
    "not-key-type": {
        readonly default: "Cannot copy keys from a non-key type (KeysOf<T> or ParentKeysOf<T>)";
    };
    "resource-missing-key": {
...
}, C, M>) => void, createDiagnostic: <C extends "not-key-type" | "resource-missing-key" | "resource-missing-error" | "duplicate-key" | "duplicate-parent-key" | "invalid-action-name" | "shared-route-unspecified-action-name" | "circular-parent-resource", M extends keyof {
    "not-key-type": {
        readonly default: "Cannot copy keys from a non-key type (KeysOf<T> or ParentKeysOf<T>)";
    };
    "resource-missing-key": {
