...
export const $lib = createTypeSpecLibrary({
    ...
    diagnostics: {
        "terminal-event-not-in-events": {
            severity: "error",
            messages: {
                default: "A field marked as '@terminalEvent' must be a member of a type decorated with '@TypeSpec.Events.events'.",
            },
        },
        "sse-stream-union-not-events": {
            severity: "error",
            messages: {
                default: "SSEStream type parameter must be a union decorated with '@TypeSpec.Events.events'.",
            },
        },
    },
    state: {
