...
async function testResolveOperationId(code, strategy) {
...
describe("parent-container strategy", () => {
    ...
    `);
        ...
        expect(resolver.resolve(op1)).toEqual("One_test");
        expect(resolver.resolve(op2)).toEqual("One_test_2");
    });
});
describe("fqn", () => {
    it("return operation name if operation is defined at the root", async () => {
...
describe("explicit-only", () => {
    it("return operationId explicitly set", async () => {
        const id = await testResolveOperationId(`@test @OpenAPI.operationId("explicit_foo") op foo(): string;`, "explicit-only");
...
//# sourceMappingURL=operation-id-resolver.test.js.map