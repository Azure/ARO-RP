import { type BooleanLiteral, type Enum, type EnumMember, type Interface, type IntrinsicType, type Model, type ModelProperty, type Namespace, type NumericLiteral, type Operation, type Program, type Scalar, type StringLiteral, type StringTemplate, type Tuple, type Type, type Union, type UnionVariant } from "@typespec/compiler";
import type { Context } from "vm";
import type { Placeholder } from "./placeholder.js";
import { ReferenceCycle } from "./reference-cycle.js";
import type { AssetEmitter, Declaration, EmitEntity, EmittedSourceFile, Scope, SourceFile, TypeSpecDeclaration } from "./types.js";
