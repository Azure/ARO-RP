import { compilerAssert, getTypeName, isTemplateDeclaration, joinPaths, } from "@typespec/compiler";
...
export function createAssetEmitter(program, TypeEmitterClass, emitContext) {
    ...
    function setContextForType(method, args) {
        ...
        const isUnspeakableInstantiation = (method === "modelInstantiation" || method === "unionInstantiation") && args[1] === undefined;
