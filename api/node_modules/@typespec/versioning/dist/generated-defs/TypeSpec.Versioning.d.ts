import type { DecoratorContext, DecoratorValidatorCallbacks, Enum, EnumMember, Interface, Model, ModelProperty, Namespace, Operation, Scalar, Type, Union, UnionVariant } from "@typespec/compiler";
/**
 ...
 * ```
 */
export type VersionedDecorator = (context: DecoratorContext, target: Namespace, versions: Enum) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type UseDependencyDecorator = (context: DecoratorContext, target: EnumMember | Namespace, ...versionRecords: EnumMember[]) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type AddedDecorator = (context: DecoratorContext, target: Model | ModelProperty | Operation | Enum | EnumMember | Union | UnionVariant | Scalar | Interface, version: EnumMember) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type RemovedDecorator = (context: DecoratorContext, target: Model | ModelProperty | Operation | Enum | EnumMember | Union | UnionVariant | Scalar | Interface, version: EnumMember) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type RenamedFromDecorator = (context: DecoratorContext, target: Model | ModelProperty | Operation | Enum | EnumMember | Union | UnionVariant | Scalar | Interface, version: EnumMember, oldName: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type MadeOptionalDecorator = (context: DecoratorContext, target: ModelProperty, version: EnumMember) => DecoratorValidatorCallbacks | void;
/**
...
//# sourceMappingURL=TypeSpec.Versioning.d.ts.map