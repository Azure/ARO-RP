import type { DecoratorContext, DecoratorValidatorCallbacks, Enum, EnumValue, FunctionContext, Interface, Model, ModelProperty, Namespace, Numeric, Operation, Scalar, ScalarValue, Type, Union, UnionVariant } from "../src/index.js";
...
export type ApplyVisibilityFilterFunctionImplementation = (context: FunctionContext, input: Model, filter: VisibilityFilter, nameTemplate?: string) => Model;
export type ApplyLifecycleUpdateFunctionImplementation = (context: FunctionContext, input: Model, nameTemplate?: string) => Model;
