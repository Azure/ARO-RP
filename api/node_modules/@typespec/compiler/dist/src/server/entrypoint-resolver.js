...
export async function resolveEntrypointFile(host, entrypoints, path, fileSystemCache, log) {
    ...
    async function existingFile(dir, file) {
        const candidate = joinPaths(dir, file);
        const stat = await doIO(() => host.stat(candidate), candidate, logMainFileSearchDiagnostic, options);
        return stat?.isFile() ? candidate : undefined;
    }
}
//# sourceMappingURL=entrypoint-resolver.js.map