import { CodeAction, CodeActionKind, CompletionList, DiagnosticSeverity, DiagnosticTag, DocumentHighlightKind, FileChangeType, MarkupKind, Range, SemanticTokensBuilder, TextDocumentSyncKind, TextEdit, } from "vscode-languageserver/node.js";
...
export function createServer(host, clientConfigsProvider) {
    ...
    async function getCodeActions(params) {
        ...
        for (const vsDiag of params.context.diagnostics) {
            ...
            if (tspDiag === undefined || tspDiag.codefixes === undefined)
                continue;
            for (const fix of tspDiag.codefixes ?? []) {
                const codeAction = {
                    ...CodeAction.create(fix.label, {
                        title: fix.label,
