...
import { fileURLToPath, isFile, listDirHierarchy, parseNodeModuleSpecifier, pathToFileURL, readPackage, } from "./utils.js";
...
export async function resolveModule(host, specifier, options) {
     ...
     */
    async function resolveAsNodeModule(specifier, baseDir) {
        ...
        try {
            match = await resolvePackageImports({
                ...
                resolveId: async (id, baseDir) => {
                    ...
                    if (specifier === null)
                        return undefined;
                    const resolved = await resolveAsNodeModule(specifier, fileURLToPath(baseDir.toString()));
