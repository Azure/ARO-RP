...
export function parseNodeModuleSpecifier(id) {
...
export async function readPackage(host, pkgfile) {
...
export async function isFile(host, path) {
    try {
 ...
 */
export function listDirHierarchy(baseDir) {
    const paths = [baseDir];
