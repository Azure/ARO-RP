...
export class NodePackageResolver {
     ...
     */
    async resolve(specifier, baseDir) {
        return ((await this.resolveSelf(specifier, baseDir)) ??
     ...
     */
    async resolveSelf(packageName, baseDir) {
     ...
     */
    async resolveFromNodeModules(packageName, baseDir) {
...
//# sourceMappingURL=node-package-resolver.js.map