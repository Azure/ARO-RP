import type { DecoratorContext, DecoratorValidatorCallbacks, Enum, ModelProperty, Type } from "@typespec/compiler";
/**
 ...
 * ```
 */
export type NameDecorator = (context: DecoratorContext, target: Type, name: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type AttributeDecorator = (context: DecoratorContext, target: ModelProperty) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type UnwrappedDecorator = (context: DecoratorContext, target: ModelProperty) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type NsDecorator = (context: DecoratorContext, target: Type, ns: Type, prefix?: string) => DecoratorValidatorCallbacks | void;
/**
 * Mark an enum as declaring XML namespaces. See `@ns`
 */
export type NsDeclarationsDecorator = (context: DecoratorContext, target: Enum) => DecoratorValidatorCallbacks | void;
...
//# sourceMappingURL=TypeSpec.Xml.d.ts.map