...
import { getCookieParamOptions, getHeaderFieldOptions, getPathOptions, getQueryOptions, isBody, isBodyIgnore, isBodyRoot, isMultipartBodyProperty, isStatusCode, resolvePathOptionsWithDefaults, resolveQueryOptionsWithDefaults, } from "./decorators.js";
...
function getHttpProperty(program, property, path, options = {}) {
    ...
    if (implicit && defined.length > 0) {
        if (implicit.type === "path" && annotations.path) {
            if (annotations.path.explode !== undefined ||
 ...
 */
export function resolvePayloadProperties(program, type, visibility, disposition, options = {}) {
