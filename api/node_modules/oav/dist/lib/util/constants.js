...
exports.DefaultConfig = exports.unknownResourceType = exports.unknownOperationId = exports.unknownApiVersion = exports.unknownResourceProvider = exports.EnvironmentVariables = exports.knownTitleToResourceProviders = exports.ErrorCodes = exports.Warnings = exports.Errors = exports.xmsReadonlyRef = exports.exampleInSpec = exports.xNullable = exports.xmsSecret = exports.xmsAzureResource = exports.xmsMutability = exports.xmsEnum = exports.xmsDiscriminatorValue = exports.xmsLongRunningOperationOptionsField = exports.xmsLongRunningOperationOptions = exports.xmsLongRunningOperation = exports.xmsSkipUrlEncoding = exports.xmsExamples = exports.xmsPaths = exports.xmsParameterizedHost = void 0;
exports.xmsParameterizedHost = "x-ms-parameterized-host";
exports.xmsPaths = "x-ms-paths";
exports.xmsExamples = "x-ms-examples";
exports.xmsSkipUrlEncoding = "x-ms-skip-url-encoding";
exports.xmsLongRunningOperation = "x-ms-long-running-operation";
exports.xmsLongRunningOperationOptions = "x-ms-long-running-operation-options";
exports.xmsLongRunningOperationOptionsField = "final-state-via";
exports.xmsDiscriminatorValue = "x-ms-discriminator-value";
exports.xmsEnum = "x-ms-enum";
exports.xmsMutability = "x-ms-mutability";
exports.xmsAzureResource = "x-ms-azure-resource";
exports.xmsSecret = "x-ms-secret";
exports.xNullable = "x-nullable";
exports.exampleInSpec = "example-in-spec";
exports.xmsReadonlyRef = "x-ms-readonly-ref";
...
exports.knownTitleToResourceProviders = {
...
exports.unknownResourceProvider = "microsoft.unknown";
exports.unknownApiVersion = "unknown-api-version";
exports.unknownOperationId = "unknownOperationId";
exports.unknownResourceType = "unknownResourceType";
