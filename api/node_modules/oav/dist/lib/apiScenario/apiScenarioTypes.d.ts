...
export type VarValue = boolean | number | string | VarValue[] | {
    [key: string]: VarValue;
};
export type Variable = BoolVariable | IntVariable | StringVariable | SecureStringVariable | ArrayVariable | ObjectVariable | SecureObjectVariable;
...
export type RawAuthentication = RawNoneAuthentication | RawAADTokenAuthentication | RawAzureKeyAuthentication;
...
export type RawStep = RawStepOperation | RawStepExample | RawStepArmTemplate | RawStepArmScript | RawStepRoleAssignment;
...
export type StepArmTemplate = TransformRaw<RawStepArmTemplate, StepBase & {
...
export type StepRoleAssignment = TransformRaw<RawStepRoleAssignment, StepBase & {
...
export type JsonPatchOp = JsonPatchOpAdd | JsonPatchOpRemove | JsonPatchOpReplace | JsonPatchOpCopy | JsonPatchOpMove | JsonPatchOpTest;
...
export type Scenario = TransformRaw<RawScenario, {
    steps: Step[];
    authentication?: Authentication;
...
export type ScenarioDefinition = TransformRaw<RawScenarioDefinition, VariableScope & {
    name: string;
    prepareSteps: Step[];
    scenarios: Scenario[];
    cleanUpSteps: Step[];
...
export type ItemMetadata = SimpleItemMetadata | LroItemMetadata | DelayItemMetadata | PollerItemMetadata | FinalGetItemMetadata;
...
export {};
//# sourceMappingURL=apiScenarioTypes.d.ts.map