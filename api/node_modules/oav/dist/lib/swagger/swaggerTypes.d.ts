...
import { LiveValidatorLoggingLevels, LiveValidatorLoggingTypes } from "../liveValidation/liveValidator";
...
import { xmsDiscriminatorValue, xmsEnum, xmsExamples, xmsLongRunningOperation, xmsMutability, xmsParameterizedHost, xmsPaths, xmsSkipUrlEncoding, xNullable, xmsReadonlyRef, xmsAzureResource, xmsLongRunningOperationOptions, xmsLongRunningOperationOptionsField } from "../util/constants";
import { $id } from "./jsonLoader";
export declare const refSelfSymbol: unique symbol;
...
export declare const lowerHttpMethods: readonly ["get", "put", "post", "delete", "options", "head", "patch"];
...
export interface Operation {
    ...
    [xmsLongRunningOperationOptions]?: {
        [xmsLongRunningOperationOptionsField]: string;
    };
    [xmsExamples]?: {
        [description: string]: SwaggerExample;
    };
    provider?: string;
    _path: Path;
...
export type LoggingFn = (message: string, level?: LiveValidatorLoggingLevels, loggingType?: LiveValidatorLoggingTypes, operationName?: string, durationInMilliseconds?: number, validationRequest?: ValidationRequest) => void;
...
export interface SwaggerSpec {
    ...
    parameters?: {
        [parameterName: string]: BodyParameter | QueryParameter | FormDataParameter;
    };
    responses?: {
        [responseName: string]: Response;
    };
...
export {};
//# sourceMappingURL=swaggerTypes.d.ts.map