...
export declare function getClientName(context: AutorestEmitterContext, type: Type & {
    name: string;
}): string;
/**
 ...
 */
export declare function resolveOperationId(context: AutorestEmitterContext, operation: Operation): string;
/**
 ...
 */
export declare function isSupportedAutorestFormat(formatStr: string): boolean;
