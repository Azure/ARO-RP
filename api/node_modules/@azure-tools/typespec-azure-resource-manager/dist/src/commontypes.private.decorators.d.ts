...
import { ArmCommonDefinitionDecorator, ArmCommonParameterDecorator, ArmCommonTypesVersionsDecorator, InlineAzureTypeDecorator } from "../generated-defs/Azure.ResourceManager.CommonTypes.Private.js";
...
export declare const getInlineAzureType: (program: Program, type: ModelProperty) => boolean | undefined, setInlineAzureType: (program: Program, type: ModelProperty, value: boolean) => void;
export declare const $inlineAzureType: InlineAzureTypeDecorator;
