...
import { getClientInitializationOptions, getClientNameOverride, getClientNamespace, listOperationGroups, } from "./decorators.js";
import { getSdkHttpParameter } from "./http.js";
import { InitializedByFlags, UsageFlags, } from "./interfaces.js";
import { createGeneratedName, getActualClientType, getClientDoc, getTypeDecorators, getValueTypeValue, isSubscriptionId, updateWithApiVersionInformation, } from "./internal-utils.js";
...
export function createSdkClientType(context, client, parent) {
    ...
    const sdkClientType = {
        ...
        clientInitialization: diagnostics.pipe(createSdkClientInitializationType(context, client, parent)),
...
function createSdkClientInitializationType(context, client, parent) {
    const diagnostics = createDiagnosticCollector();
    ...
    if (client.type) {
        ...
        if (initializationOptions?.initializedBy !== undefined) {
            if (initializationOptions.initializedBy !== InitializedByFlags.CustomizeCode &&
            ...
            else if (initializationOptions.initializedBy !== InitializedByFlags.CustomizeCode &&
