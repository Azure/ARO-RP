...
export type ArrayKnownEncoding = "pipeDelimited" | "spaceDelimited" | "commaDelimited" | "newlineDelimited";
/**
...
interface SdkServiceMethodBase<TServiceOperation extends SdkServiceOperation> extends DecoratedType {
    __raw?: Operation;
    name: string;
    /** Whether the type has public or private accessibility */
    access: AccessFlags;
 ...
 */
export type SdkLroServiceFinalStep = SdkFinalOperationLink | SdkFinalOperationReference | SdkPollingSuccessProperty | SdkNoPollingSuccessProperty;
