import type { DecoratorContext, DecoratorValidatorCallbacks, Model, ModelProperty, Numeric, Operation, Type } from "@typespec/compiler";
/**
 ...
 * ```
 */
export type HierarchyBuildingDecorator = (context: DecoratorContext, target: Model, value: Model, scope?: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type FlattenPropertyDecorator = (context: DecoratorContext, target: ModelProperty, scope?: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type MarkAsLroDecorator = (context: DecoratorContext, target: Operation, scope?: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type MarkAsPageableDecorator = (context: DecoratorContext, target: Operation, scope?: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type DisablePageableDecorator = (context: DecoratorContext, target: Operation, scope?: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type NextLinkVerbDecorator = (context: DecoratorContext, target: Operation, verb: Type, scope?: string) => DecoratorValidatorCallbacks | void;
/**
 ...
 * ```
 */
export type ClientDefaultValueDecorator = (context: DecoratorContext, target: ModelProperty, value: string | boolean | Numeric, scope?: string) => DecoratorValidatorCallbacks | void;
...
//# sourceMappingURL=Azure.ClientGenerator.Core.Legacy.d.ts.map