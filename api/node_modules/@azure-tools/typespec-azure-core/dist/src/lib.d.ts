export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "preview-version-invalid-enum-member": {
        readonly default: "@previewVersion can only be applied to members of a Version enum.";
    };
    "preview-version-last-member": {
        readonly default: "@previewVersion can only be applied to the last member of a Version enum. Having it on other members will cause unstable apis to show up in subsequent stable versions.";
    };
