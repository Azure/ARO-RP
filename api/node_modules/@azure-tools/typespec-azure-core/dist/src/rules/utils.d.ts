import { CallableMessage, DecoratedType, DiagnosticTarget, Enum, EnumMember, Interface, LinterRuleContext, Model, ModelProperty, Namespace, Operation, Program, Scalar, Type, Union, UnionVariant } from "@typespec/compiler";
...
export declare function isPascalCaseWithAcceptedAcronyms(name: string, acceptedAcronyms: string[]): boolean;
/**
...
export declare function checkReferenceInDisallowedNamespace(context: LinterRuleContext<{
    readonly default: CallableMessage<["ns"]>;
}>, origin: Type, type: Type, target: DiagnosticTarget, disallowedNamespace: "Private" | "Legacy"): void;
export declare function checkDecoratorsInDisallowedNamespace(context: LinterRuleContext<{
    readonly default: CallableMessage<["ns"]>;
}>, type: Type & DecoratedType, disallowedNamespace: "Private" | "Legacy"): void;
export declare function isInDisallowedNamespace(type: Type, disallowedNamespace: "Private" | "Legacy"): type is Type & {
    namespace: Namespace;
};
export {};
