...
export function isPascalCaseWithAcceptedAcronyms(name, acceptedAcronyms) {
...
export function checkReferenceInDisallowedNamespace(context, origin, type, target, disallowedNamespace) {
...
export function checkDecoratorsInDisallowedNamespace(context, type, disallowedNamespace) {
...
export function isInDisallowedNamespace(type, disallowedNamespace) {
