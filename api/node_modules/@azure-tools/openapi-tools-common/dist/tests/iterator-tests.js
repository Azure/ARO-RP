...
const _ = __importStar(require("../libs/iterator"));
describe("map", () => {
    it("array", () => {
...
function readonlyArrayOrString(v) {
    return v;
}
describe("isArray", () => {
    it("array", () => {
...
describe("uniq", () => {
    ...
    it("complex", () => {
        const result = _.toArray(_.uniq([{ a: 3 }, { a: 1 }, { a: 2 }, { a: 2 }, { a: 3 }], v => v.a));
...
//# sourceMappingURL=iterator-tests.js.map