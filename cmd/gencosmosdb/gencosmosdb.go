...
import (
	...
	"github.com/Azure/ARO-RP/pkg/util/gencosmosdb"
)
...
func writeFile(filename string, data []byte) error {
	...
	data = packageRegexp.ReplaceAll(data, []byte("// Code generated by github.com/Azure/ARO-RP/pkg/util/gencosmosdb, DO NOT EDIT.\n\npackage "+*pkg))
