...
go mod edit -replace github.com/openshift/installer=github.com/jim-minter/installer@$(curl https://proxy.golang.org/github.com/jim-minter/installer/@v/release-4.6-azure-slim.info | jq -r ."Version")
