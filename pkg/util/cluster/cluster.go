...
import (
	...
	redhatopenshift20220620preview "github.com/Azure/ARO-RP/pkg/util/azureclient/mgmt/redhatopenshift/2022-06-20-preview/redhatopenshift"
...
type Cluster struct {
	...
	openshiftclustersv20220620preview redhatopenshift20220620preview.OpenShiftClustersClient
...
func New(log *logrus.Entry, environment env.Core, ci bool) (*Cluster, error) {
	...
	c := &Cluster{
		...
		openshiftclustersv20220620preview: redhatopenshift20220620preview.NewOpenShiftClustersClient(environment.Environment(), environment.SubscriptionID(), authorizer),
