...
//
//	mockgen -destination=../util/mocks/env/core.go -source core.go -aux_files github.com/Azure/ARO-RP/pkg/env=core.go,github.com/Azure/ARO-RP/pkg/env=armhelper.go
//
...
func (mr *MockCoreMockRecorder) NewLiveConfigManager(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoreMockRecorder) NewMSIAuthorizer(scope any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
