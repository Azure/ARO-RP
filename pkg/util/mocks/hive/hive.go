...
// Source: github.com/Azure/ARO-RP/pkg/hive (interfaces: ClusterManager,SyncSetResourceManager)
...
// MockSyncSetResourceManager is a mock of SyncSetResourceManager interface.
type MockSyncSetResourceManager struct {
	ctrl     *gomock.Controller
	recorder *MockSyncSetResourceManagerMockRecorder
}

// MockSyncSetResourceManagerMockRecorder is the mock recorder for MockSyncSetResourceManager.
type MockSyncSetResourceManagerMockRecorder struct {
	mock *MockSyncSetResourceManager
}

// NewMockSyncSetResourceManager creates a new mock instance.
func NewMockSyncSetResourceManager(ctrl *gomock.Controller) *MockSyncSetResourceManager {
	mock := &MockSyncSetResourceManager{ctrl: ctrl}
	mock.recorder = &MockSyncSetResourceManagerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSyncSetResourceManager) EXPECT() *MockSyncSetResourceManagerMockRecorder {
	return m.recorder
}

// GetSyncSetResources mocks base method.
func (m *MockSyncSetResourceManager) GetSyncSetResources(arg0 context.Context, arg1 *api.OpenShiftClusterDocument) ([]v1alpha1.ClusterSync, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSyncSetResourceManagerMockRecorder) GetSyncSetResources(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSyncSetResources", reflect.TypeOf((*MockSyncSetResourceManager)(nil).GetSyncSetResources), arg0, arg1)
}
