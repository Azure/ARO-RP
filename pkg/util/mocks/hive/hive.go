...
import (
	...
	hive "github.com/Azure/ARO-RP/pkg/hive"
)
...
func (m *MockClusterManager) CreateOrUpdate(arg0 context.Context, arg1 *hive.CreateOrUpdateParameters) error {
	m.ctrl.T.Helper()
...
func (mr *MockClusterManagerMockRecorder) CreateOrUpdate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockClusterManager)(nil).CreateOrUpdate), arg0, arg1)
}
