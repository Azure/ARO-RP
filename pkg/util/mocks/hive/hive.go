...
//
//	mockgen -destination=../util/mocks/hive/hive.go github.com/Azure/ARO-RP/pkg/hive ClusterManager
//
...
func (mr *MockClusterManagerMockRecorder) GetSyncSetResources(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
