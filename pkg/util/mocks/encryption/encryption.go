...
//
//	mockgen -destination=../mocks/encryption/encryption.go github.com/Azure/ARO-RP/pkg/util/encryption AEAD
//
...
func (mr *MockAEADMockRecorder) Open(arg0 any) *gomock.Call {
...
func (mr *MockAEADMockRecorder) Seal(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
