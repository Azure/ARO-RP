...
//
//	mockgen -destination=../../util/mocks/billing/billing.go github.com/Azure/ARO-RP/pkg/util/billing Manager
//
...
func (mr *MockManagerMockRecorder) Ensure(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
