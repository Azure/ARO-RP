...
// Source: github.com/Azure/ARO-RP/pkg/frontend/adminactions (interfaces: KubeActions,AzureActions,OCMActions)
...
// MockOCMActions is a mock of OCMActions interface.
type MockOCMActions struct {
	ctrl     *gomock.Controller
	recorder *MockOCMActionsMockRecorder
}

// MockOCMActionsMockRecorder is the mock recorder for MockOCMActions.
type MockOCMActionsMockRecorder struct {
	mock *MockOCMActions
}

// NewMockOCMActions creates a new mock instance.
func NewMockOCMActions(ctrl *gomock.Controller) *MockOCMActions {
	mock := &MockOCMActions{ctrl: ctrl}
	mock.recorder = &MockOCMActionsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockOCMActions) EXPECT() *MockOCMActionsMockRecorder {
	return m.recorder
}

// CancelClusterUpgradePolicy mocks base method.
func (m *MockOCMActions) CancelClusterUpgradePolicy(arg0 context.Context, arg1 string) (*api.CancelUpgradeResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CancelClusterUpgradePolicy", arg0, arg1)
...
func (mr *MockOCMActionsMockRecorder) CancelClusterUpgradePolicy(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CancelClusterUpgradePolicy", reflect.TypeOf((*MockOCMActions)(nil).CancelClusterUpgradePolicy), arg0, arg1)
}

// GetClusterInfoWithUpgradePolicies mocks base method.
func (m *MockOCMActions) GetClusterInfoWithUpgradePolicies(arg0 context.Context) (*api.ClusterInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClusterInfoWithUpgradePolicies", arg0)
	ret0, _ := ret[0].(*api.ClusterInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetClusterInfoWithUpgradePolicies indicates an expected call of GetClusterInfoWithUpgradePolicies.
func (mr *MockOCMActionsMockRecorder) GetClusterInfoWithUpgradePolicies(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClusterInfoWithUpgradePolicies", reflect.TypeOf((*MockOCMActions)(nil).GetClusterInfoWithUpgradePolicies), arg0)
}
