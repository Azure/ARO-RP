...
func (mr *MockRecordSetsClientMockRecorder) CreateOrUpdate(ctx, resourceGroupName, zoneName, relativeRecordSetName, recordType, parameters, options interface{}) *gomock.Call {
...
func (mr *MockRecordSetsClientMockRecorder) Delete(ctx, resourceGroupName, zoneName, relativeRecordSetName, recordType, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRecordSetsClientMockRecorder) Get(ctx, resourceGroupName, zoneName, relativeRecordSetName, recordType, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockZonesClientMockRecorder) Get(ctx, resourceGroupName, zoneName, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
