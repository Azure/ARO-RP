...
func (m *MockVirtualMachinesClient) GetWithInstanceView(ctx context.Context, resourceGroupName, vmName string) (armcompute.VirtualMachine, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWithInstanceView", ctx, resourceGroupName, vmName)
	ret0, _ := ret[0].(armcompute.VirtualMachine)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetWithInstanceView indicates an expected call of GetWithInstanceView.
func (mr *MockVirtualMachinesClientMockRecorder) GetWithInstanceView(ctx, resourceGroupName, vmName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWithInstanceView", reflect.TypeOf((*MockVirtualMachinesClient)(nil).GetWithInstanceView), ctx, resourceGroupName, vmName)
}
