...
//
//	mockgen -source ./user_assigned_identities.go -destination=../../../mocks/azureclient/azuresdk/armmsi/armmsi.go github.com/Azure/ARO-RP/pkg/util/azureclient/azuresdk/armmsi UserAssignedIdentitiesClient
//
