...
// DeleteAndWait mocks base method.
func (m *MockDiskEncryptionSetsClient) DeleteAndWait(arg0 context.Context, arg1, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAndWait", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteAndWait indicates an expected call of DeleteAndWait.
func (mr *MockDiskEncryptionSetsClientMockRecorder) DeleteAndWait(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAndWait", reflect.TypeOf((*MockDiskEncryptionSetsClient)(nil).DeleteAndWait), arg0, arg1, arg2)
}
