...
// Source: github.com/Azure/ARO-RP/pkg/util/azureclient/mgmt/network (interfaces: InterfacesClient,PrivateEndpointsClient,PublicIPAddressesClient,SubnetsClient,VirtualNetworksClient)
