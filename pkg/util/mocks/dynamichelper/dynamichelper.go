...
// Source: github.com/Azure/ARO-RP/pkg/util/dynamichelper (interfaces: Interface,GVRResolver)
...
// MockGVRResolver is a mock of GVRResolver interface.
type MockGVRResolver struct {
	ctrl     *gomock.Controller
	recorder *MockGVRResolverMockRecorder
}

// MockGVRResolverMockRecorder is the mock recorder for MockGVRResolver.
type MockGVRResolverMockRecorder struct {
	mock *MockGVRResolver
}

// NewMockGVRResolver creates a new mock instance.
func NewMockGVRResolver(ctrl *gomock.Controller) *MockGVRResolver {
	mock := &MockGVRResolver{ctrl: ctrl}
	mock.recorder = &MockGVRResolverMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockGVRResolver) EXPECT() *MockGVRResolverMockRecorder {
	return m.recorder
}

// Refresh mocks base method.
func (m *MockGVRResolver) Refresh() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Refresh")
	ret0, _ := ret[0].(error)
	return ret0
...
// Refresh indicates an expected call of Refresh.
func (mr *MockGVRResolverMockRecorder) Refresh() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Refresh", reflect.TypeOf((*MockGVRResolver)(nil).Refresh))
}

// Resolve mocks base method.
func (m *MockGVRResolver) Resolve(arg0, arg1 string) (*schema.GroupVersionResource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGVRResolverMockRecorder) Resolve(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Resolve", reflect.TypeOf((*MockGVRResolver)(nil).Resolve), arg0, arg1)
}
