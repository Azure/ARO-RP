...
// NewBlobsClient creates a new BlobsClient
func NewBlobsClientUsingSAS(ctx context.Context, sasURL string, environment *azureclient.AROEnvironment) (*blobsClient, error) {
