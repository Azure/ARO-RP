...
const (
	...
	// ifxAuditPopSample is the effective percentage sample rate for this event at
	// the time it was generated by a client (either the default value specified in
