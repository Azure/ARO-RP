...
func TestFairfaxGetTlsConfig(t *testing.T) {
	kpiUrl := "https://issuer.pki.azure.us/dsms/issuercertificates?getissuersv3&caName=%s"
	testUrl := "https://diag-runtimehost-prod-bn1-001.azurewebsites.us"
