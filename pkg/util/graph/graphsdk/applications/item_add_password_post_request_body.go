...
func (m *ItemAddPasswordPostRequestBody) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["passwordCredential"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(i41bcc35ce32714d516294a23ce1c45d33e169802291ff51166cf13043c547b8a.CreatePasswordCredentialFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetPasswordCredential(val.(i41bcc35ce32714d516294a23ce1c45d33e169802291ff51166cf13043c547b8a.PasswordCredentialable))
		}
		return nil
	}
	return res
...
func (m *ItemAddPasswordPostRequestBody) GetPasswordCredential() i41bcc35ce32714d516294a23ce1c45d33e169802291ff51166cf13043c547b8a.PasswordCredentialable {
	...
	if val != nil {
		return val.(i41bcc35ce32714d516294a23ce1c45d33e169802291ff51166cf13043c547b8a.PasswordCredentialable)
	}
	return nil
}
