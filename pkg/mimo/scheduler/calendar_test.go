...
func TestNext(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			sched: calendar{Year: []int{2028}, Month: []int{1}, Day: []int{1}, Hour: []int{0}, Minute: []int{0}, Second: []int{0}},
		...
		},
		{
			...
			sched: calendar{Day: []int{1}, Hour: []int{0}, Minute: []int{0}, Second: []int{0}},
		...
		},
		{
			name:  "next day",
			now:   time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
			sched: calendar{Hour: []int{0}, Minute: []int{0}, Second: []int{0}},
		...
		},
		{
			name:  "next monday",
			now:   time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
			sched: calendar{Weekday: []time.Weekday{time.Monday}, Hour: []int{0}, Minute: []int{0}, Second: []int{0}},
		...
		},
		{
			name:  "next hour",
			now:   time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
			sched: calendar{Minute: []int{0}, Second: []int{0}},
		...
		},
		{
			name:  "next half hour",
			now:   time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
			sched: calendar{Minute: []int{30}, Second: []int{0}},
		...
		},
		{
			name:  "next 15 mins",
			now:   time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
			sched: calendar{Minute: []int{0, 15, 30, 45}, Second: []int{0}},
