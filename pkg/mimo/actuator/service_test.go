...
func TestActuatorPerformsMaintenance(t *testing.T) {
	r := require.New(t)
	ctx := t.Context()
	...
	fixtures.AddPoolWorkerDocuments(&api.PoolWorkerDocument{
		ID:         string(api.PoolWorkerTypeMIMOActuator),
		WorkerType: api.PoolWorkerTypeMIMOActuator,
...
func TestActuatorGoesReadyEvenIfNoWork(t *testing.T) {
	r := require.New(t)
	ctx := t.Context()
