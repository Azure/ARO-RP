...
func AllConditionTypes() []string {
	return []string{InternetReachableFromMaster, InternetReachableFromWorker, MachineValid, ServicePrincipalValid, ManagedUpgradeOperatorStatus, GuardRailsStatus}
}
