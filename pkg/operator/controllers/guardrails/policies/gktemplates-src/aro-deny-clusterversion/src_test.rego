...
test_input_allowed_regular_user_update_clusterversion {
...
test_input_disallowed_regular_user_update_clusterversion {
	input := {"review": input_configmap("regular-user", "regular-user", "UPDATE")}
...
test_input_allowed_system_user_update_clusterversion {
...
test_allowed_regular_user_delete_clusterversion {
...
test_disallowed_regular_user_delete_clusterversion {
	input := {"review": input_configmap("regular-user", "regular-user", "DELETE")}
	inv := inv_data(create_data_ocm([]))
	results := violation with input as input with data.inventory as inv
	count(results) == 1
...
test_allowed_system_user_delete_clusterversion {
...
test_allowed_regular_user_create_clusterversion {
...
test_disallowed_regular_user_create_clusterversion {
	input := {"review": input_configmap("regular-user", "regular-user", "CREATE")}
	inv := inv_data(create_data_ocm([]))
	results := violation with input as input with data.inventory as inv
	count(results) == 1
...
test_create_allowed_system_user_create_clusterversion {
