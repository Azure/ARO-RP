...
//
// * ClusterReconciler detects "clusterhosted" and skips dnsmasq reconciliation.
//
...
//
// * Machine Config Operator (MCO) renders CoreDNS static pod on all nodes.
//
// # Controllers
//
// This package contains three reconcilers:
//
// func (*ClusterReconciler) Reconcile watches the ARO Cluster object and
// ClusterVersion for changes. For dnsmasq clusters, it reconciles all
// 99-%s-aro-dns MachineConfigs. For CustomDNS clusters, it returns early.
//
