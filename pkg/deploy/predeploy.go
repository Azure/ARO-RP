...
// deployment
func (d *deployer) PreDeploy(ctx context.Context, lbHealthcheckWaitTimeSec int, hasAKS bool) error {
	// deploy global rbac
	...
	rpProdPreDeployFile := generator.FileRPProductionPredeployNoAks
	if hasAKS {
