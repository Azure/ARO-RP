...
HOLMES_IMAGE='$HOLMESIMAGE'
HOLMES_AZURE_API_VERSION='$HOLMESAZUREAPIVERSION'
HOLMES_MODEL='$HOLMESMODEL'
HOLMES_DEFAULT_TIMEOUT='$HOLMESDEFAULTTIMEOUT'
HOLMES_MAX_CONCURRENT='$HOLMESMAXCONCURRENT'
"
