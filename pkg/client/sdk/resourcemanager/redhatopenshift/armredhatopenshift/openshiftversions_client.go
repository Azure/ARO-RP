...
// Get - Gets an available OpenShift version to install in the specified location.
//
...
func (client *OpenShiftVersionsClient) Get(ctx context.Context, location string, openShiftVersion string, options *OpenShiftVersionsClientGetOptions) (OpenShiftVersionsClientGetResponse, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftVersionsClient.Get", client.internal.Tracer(), nil)
...
// NewListPager - Lists all OpenShift versions available to install in the specified location.
//
