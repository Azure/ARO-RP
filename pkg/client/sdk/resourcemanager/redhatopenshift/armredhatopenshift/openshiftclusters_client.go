...
// BeginCreateOrUpdate - Creates or updates a OpenShift cluster with the specified subscription, resource group and resource
// name.
//
...
// CreateOrUpdate - Creates or updates a OpenShift cluster with the specified subscription, resource group and resource name.
//
// The operation returns properties of a OpenShift cluster.
// If the operation fails it returns an *azcore.ResponseError type.
func (client *OpenShiftClustersClient) createOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, parameters OpenShiftCluster, options *OpenShiftClustersClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftClustersClient.BeginCreateOrUpdate", client.internal.Tracer(), nil)
...
// BeginDelete - Deletes a OpenShift cluster with the specified subscription, resource group and resource name.
//
...
// Delete - Deletes a OpenShift cluster with the specified subscription, resource group and resource name.
//
// The operation returns nothing.
// If the operation fails it returns an *azcore.ResponseError type.
func (client *OpenShiftClustersClient) deleteOperation(ctx context.Context, resourceGroupName string, resourceName string, options *OpenShiftClustersClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftClustersClient.BeginDelete", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// Get - Gets a OpenShift cluster with the specified subscription, resource group and resource name.
//
// The operation returns properties of a OpenShift cluster.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *OpenShiftClustersClient) Get(ctx context.Context, resourceGroupName string, resourceName string, options *OpenShiftClustersClientGetOptions) (OpenShiftClustersClientGetResponse, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftClustersClient.Get", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *OpenShiftClustersClient) getHandleResponse(resp *http.Response, successCodes ...int) (OpenShiftClustersClientGetResponse, error) {
...
// NewListPager - Lists OpenShift clusters in the specified subscription.
//
...
func (client *OpenShiftClustersClient) listCreateRequest(ctx context.Context, nextLink string, _ *OpenShiftClustersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OpenShiftClustersClient) listHandleResponse(resp *http.Response, successCodes ...int) (OpenShiftClustersClientListResponse, error) {
...
// ListAdminCredentials - Lists admin kubeconfig of an OpenShift cluster with the specified subscription, resource group and
// resource name.
//
...
func (client *OpenShiftClustersClient) ListAdminCredentials(ctx context.Context, resourceGroupName string, resourceName string, options *OpenShiftClustersClientListAdminCredentialsOptions) (OpenShiftClustersClientListAdminCredentialsResponse, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftClustersClient.ListAdminCredentials", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *OpenShiftClustersClient) listAdminCredentialsHandleResponse(resp *http.Response, successCodes ...int) (OpenShiftClustersClientListAdminCredentialsResponse, error) {
...
// NewListByResourceGroupPager - Lists OpenShift clusters in the specified subscription and resource group.
//
// The operation returns properties of each OpenShift cluster.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *OpenShiftClustersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *OpenShiftClustersClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *OpenShiftClustersClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (OpenShiftClustersClientListByResourceGroupResponse, error) {
...
// ListCredentials - Lists credentials of an OpenShift cluster with the specified subscription, resource group and resource
// name.
//
...
func (client *OpenShiftClustersClient) ListCredentials(ctx context.Context, resourceGroupName string, resourceName string, options *OpenShiftClustersClientListCredentialsOptions) (OpenShiftClustersClientListCredentialsResponse, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftClustersClient.ListCredentials", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	...
	return client.listCredentialsHandleResponse(httpResp, http.StatusOK)
}
...
func (client *OpenShiftClustersClient) listCredentialsHandleResponse(resp *http.Response, successCodes ...int) (OpenShiftClustersClientListCredentialsResponse, error) {
...
// BeginUpdate - Updates a OpenShift cluster with the specified subscription, resource group and resource name.
//
// The operation returns properties of a OpenShift cluster.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Update - Updates a OpenShift cluster with the specified subscription, resource group and resource name.
//
// The operation returns properties of a OpenShift cluster.
// If the operation fails it returns an *azcore.ResponseError type.
func (client *OpenShiftClustersClient) update(ctx context.Context, resourceGroupName string, resourceName string, parameters OpenShiftClusterUpdate, options *OpenShiftClustersClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "OpenShiftClustersClient.BeginUpdate", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
