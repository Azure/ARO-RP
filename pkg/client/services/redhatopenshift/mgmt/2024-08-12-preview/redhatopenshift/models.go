...
const fqdn = "github.com/Azure/ARO-RP/pkg/client/services/redhatopenshift/mgmt/2024-08-12-preview/redhatopenshift"
	...
	if tracing.IsEnabled() {
		...
		defer func() {
			...
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.StatusCode
			}
	...
	if tracing.IsEnabled() {
		...
		defer func() {
			...
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.StatusCode
			}
			tracing.EndSpan(ctx, sc, err)
		}()
	}
...
type OpenShiftClusterProperties struct {
	// ProvisioningState - The cluster provisioning state. Possible values include: 'AdminUpdating', 'Canceled', 'Creating', 'Deleting', 'Failed', 'Succeeded', 'Updating'
...
func (future *OpenShiftClustersCreateOrUpdateFuture) result(client OpenShiftClustersClient) (osc OpenShiftCluster, err error) {
	...
	if osc.Response.Response, err = future.GetResult(sender); err == nil && osc.Response.StatusCode != http.StatusNoContent {
