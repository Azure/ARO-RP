...
func (n NetworkProfile) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "softwareDefinedNetwork", n.SoftwareDefinedNetwork)
	return json.Marshal(objectMap)
}
...
func (n *NetworkProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "serviceCidr":
			...
			delete(rawMsg, key)
		case "softwareDefinedNetwork":
			err = unpopulate(val, "SoftwareDefinedNetwork", &n.SoftwareDefinedNetwork)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", n, err)
