...
// ActorType enumerates the values for actor type.
...
const (
	...
	Key ActorType = "Key"
	// ManagedIdentity ...
	ManagedIdentity ActorType = "ManagedIdentity"
	// User ...
	User ActorType = "User"
)

// PossibleActorTypeValues returns an array of possible values for the ActorType const type.
func PossibleActorTypeValues() []ActorType {
	return []ActorType{Application, Key, ManagedIdentity, User}
}
