...
func (e *etcdrenew) validateClusterVersion(ctx context.Context) error {
	...
	if err != nil {
		return api.NewCloudError(http.StatusInternalServerError, api.CloudErrorCodeInternalServerError, "", "failed to decode clusterversion, %s", err.Error())
	}
...
func (e *etcdrenew) validateEtcdOperatorControllersState(ctx context.Context) error {
	...
	if err != nil {
		return api.NewCloudError(http.StatusInternalServerError, api.CloudErrorCodeInternalServerError, "", "failed to decode etcd object, %s", err.Error())
	}
...
func (e *etcdrenew) validateEtcdOperatorState(ctx context.Context) error {
	...
	if err != nil {
		return api.NewCloudError(http.StatusInternalServerError, api.CloudErrorCodeInternalServerError, "", "failed to decode etcd operator, %s", err.Error())
	}
...
func (e *etcdrenew) backupEtcdSecrets(ctx context.Context) error {
	...
	for _, secretname := range e.secretNames {
		err := retry.OnError(wait.Backoff{
			...
			if err != nil {
				return api.NewCloudError(http.StatusInternalServerError, api.CloudErrorCodeInternalServerError, "", "failed to decode secret, %s", err.Error())
			}
			...
			if err != nil {
				return api.NewCloudError(http.StatusInternalServerError, api.CloudErrorCodeInternalServerError, "", "failed to encode secret, %s", err.Error())
			}
