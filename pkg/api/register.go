...
type MaintenanceScheduleConverter interface {
	ToExternal(doc *MaintenanceScheduleDocument, clusterNamespaced bool) interface{}
	ToExternalList(docs []*MaintenanceScheduleDocument, nextLink string, clusterNamespaced bool) interface{}
