...
func TestOpenShiftClusterStaticValidateNetworkProfile(t *testing.T) {
	tests := []*validateTest{
		...
		},
		{
			...
			modify: func(oc *OpenShiftCluster) {
				oc.Properties.NetworkProfile.ServiceCIDR = "100.88.0.0/22"
			},
			wantErr: "400: InvalidCIDRRange: properties.networkProfile: Azure Red Hat OpenShift uses 100.64.0.0/16, 169.254.169.0/29, and 100.88.0.0/16 IP address ranges internally. Do not include this '100.88.0.0/22' IP address range in any other CIDR definitions in your cluster.",
		},
	}
...
func TestOpenShiftClusterStaticValidateDelta(t *testing.T) {
	tests := []*validateTest{
		...
		},
		{
			...
			wantErr: "400: PropertyChangeNotAllowed: properties.clusterProfile.pullSecret: Error Message: Changing property 'properties.clusterProfile.pullSecret' is not allowed.",
		},
		{
			name:    "domain change",
		...
		},
		{
			...
			wantErr: "400: PropertyChangeNotAllowed: properties.workerProfiles['new-name'].name: Error Message: Changing property 'properties.workerProfiles['new-name'].name' is not allowed.",
		},
		{
		...
		},
		{
			...
			wantErr: "400: PropertyChangeNotAllowed: properties.workerProfiles: Error Message: Changing property 'properties.workerProfiles' is not allowed.",
		},
		{
		...
		},
		{
			...
			wantErr: "400: PropertyChangeNotAllowed: systemData: Error Message: Changing property 'systemData' is not allowed.",
		},
		{
		...
		},
		{
			...
			wantErr: "400: PropertyChangeNotAllowed: properties.networkProfile.loadBalancerProfile.effectiveOutboundIps: Error Message: Changing property 'properties.networkProfile.loadBalancerProfile.effectiveOutboundIps' is not allowed.",
		},
	}
