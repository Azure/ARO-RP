...
func NewHiveMonitor(log *logrus.Entry, oc *api.OpenShiftCluster, m metrics.Emitter, hourlyRun bool, wg *sync.WaitGroup, hiveClusterManager hive.ClusterManager) (monitoring.Monitor, error) {
