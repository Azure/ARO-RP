...
func TestEmitReplicaSetsConditions(t *testing.T) {
	...
	m.EXPECT().EmitGauge("replicasets.conditions", int64(1), map[string]string{
	...
	err := mon.emitReplicaSetsConditions(ctx)
	if err != nil {
		t.Fatal(err)
	}
