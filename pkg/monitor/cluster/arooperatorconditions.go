...
var aroOperatorConditionsExpected = map[arov1alpha1.CondititionType]operatorv1.ConditionStatus{
...
func (mon *Monitor) emitAroOperatorConditions(ctx context.Context) error {
	...
	for _, c := range cluster.Status.Conditions {
		if aroOperatorConditionsExpected[arov1alpha1.CondititionType(c.Type)] == c.Status {
			continue
		}
