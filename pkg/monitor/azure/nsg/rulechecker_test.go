...
//		c.master = netip.MustParsePrefix("10.0.0.0/24")
//	}
//	for _, tt := range []struct {
//		name string
...
//	masterPrefix := netip.MustParsePrefix("10.0.0.0/24")
...
//		master   = "10.0.0.1/32"
//		masters  = []string{"10.0.0.1/32", "10.0.0.2/32"}
//		worker   = "10.0.1.1/32"
//		workers  = []string{"10.0.1.1/32", "10.0.1.2/32"}
//		wildcard = "*"
//		vnet     = "VirtualNetwork"
//	)
//	for _, tt := range []struct {
...
//	} {
//		t.Run(tt.name, func(t *testing.T) {
//			c := newRuleChecker(log, masterPrefix, workerPrefixes, &tt.rule)
