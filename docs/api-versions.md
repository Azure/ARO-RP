...
- The Azure Rest API specs "common types" are duplicated between `api/common-types` and `swagger/common-types` to avoid breaking the legacy Swagger generation `make` target.
