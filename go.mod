...
require (
	...
	github.com/openshift/hive v1.1.17
...
replace (
	...
	github.com/openshift/cluster-api-provider-ibmcloud => github.com/openshift/cluster-api-provider-ibmcloud v0.0.1-0.20220616172333-3bde969f2e83
	...
	github.com/openshift/cluster-api-provider-ovirt => github.com/openshift/cluster-api-provider-ovirt v0.1.1-0.20220623172618-5a93d94c208b
	github.com/openshift/console-operator => github.com/openshift/console-operator v0.0.0-20220902005223-378917170147
	github.com/openshift/installer => github.com/jewzaam/installer-aro v0.9.0-master.0.20221108164629-2867b943e1d9
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20221109155702-46327eb10a20
	...
	sigs.k8s.io/cluster-api-provider-aws => github.com/openshift/cluster-api-provider-aws v0.2.1-0.20220512191935-b3fe15befffb
	sigs.k8s.io/cluster-api-provider-azure => github.com/openshift/cluster-api-provider-azure v0.1.0-alpha.3.0.20220527210530-a851a3546a4f
	sigs.k8s.io/cluster-api-provider-openstack => github.com/openshift/cluster-api-provider-openstack v0.0.0-20221020185410-38f15dbc704e
...
replace sigs.k8s.io/cluster-api => github.com/openshift/cluster-api v0.0.0-20220303094157-f9c215c4f298
