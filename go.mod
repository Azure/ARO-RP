...
require (
	...
	github.com/openshift/console-operator v0.0.0-20230817005222-483bbcfcf019
...
require (
	...
	github.com/containers/buildah v1.31.3 // indirect
	...
	go.starlark.net v0.0.0-20230829175125-68633c9954b0 // indirect
