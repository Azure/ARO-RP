...
GENCOSMOSDB := $(GOBIN)/gencosmosdb-v0.0.0-20260313173900-2523aa951bd1
$(GENCOSMOSDB): $(BINGO_DIR)/gencosmosdb.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/gencosmosdb-v0.0.0-20260313173900-2523aa951bd1"
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=gencosmosdb.mod -o=$(GOBIN)/gencosmosdb-v0.0.0-20260313173900-2523aa951bd1 "github.com/bennerv/go-cosmosdb/cmd/gencosmosdb"
