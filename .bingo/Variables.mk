...
$(GENCOSMOSDB): $(BINGO_DIR)/gencosmosdb.mod
	...
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=gencosmosdb.mod -o=$(GOBIN)/gencosmosdb-v0.0.0-20260603170134-b6a927df2721 "github.com/bennerv/go-cosmosdb/cmd/gencosmosdb"
