...
$(GENCOSMOSDB): $(BINGO_DIR)/gencosmosdb.mod
	...
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=gencosmosdb.mod -o=$(GOBIN)/gencosmosdb-v0.0.0-20260318032027-4ed41099e61c "github.com/bennerv/go-cosmosdb/cmd/gencosmosdb"
