...
var _ = Describe("Cluster Operators", Label(smoke, basichealth, ocpupgrade), func() {
...
var _ = Describe("ARO Operator", Label(smoke, basichealth, ocpupgrade), func() {
...
var _ = Describe("Node Ready", Label(smoke, ocpupgrade), func() {
