...
type clientSet struct {
	...
	Operationsv20220201               redhatopenshift20220201.OperationsClient
...
func newClientSet(ctx context.Context) (*clientSet, error) {
	...
	return &clientSet{
		...
		OpenshiftClustersv20220201:        redhatopenshift20220201.NewOpenShiftClustersClient(_env.Environment(), _env.SubscriptionID(), authorizer),
		Operationsv20220201:               redhatopenshift20220201.NewOperationsClient(_env.Environment(), _env.SubscriptionID(), authorizer),
