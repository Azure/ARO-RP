...
def build_list_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.RedHatOpenShift/operations')
...
class Operations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2022_02_01.models.OperationList]
