...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.RedHatOpenShift/openShiftClusters')
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
...
def build_list_admin_credentials_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}/listAdminCredentials')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "resourceName": _SERIALIZER.url("resource_name", resource_name, 'str'),
...
def build_list_credentials_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}/listCredentials')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "resourceName": _SERIALIZER.url("resource_name", resource_name, 'str'),
...
class OpenShiftClustersOperations(object):
    ...
    :type models: ~azure.mgmt.redhatopenshift.v2022_02_01.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either OpenShiftClusterList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftClusterList]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftCluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftCluster
        :keyword api_version: Api Version. The default value is "2022-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftCluster]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type resource_name: str
        :param parameters: The OpenShift cluster resource.
        :type parameters: ~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftClusterUpdate
        :keyword api_version: Api Version. The default value is "2022-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_admin_credentials(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftClusterAdminKubeconfig
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_credentials(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.redhatopenshift.v2022_02_01.models.OpenShiftClusterCredentials
        :raises: ~azure.core.exceptions.HttpResponseError
        """
