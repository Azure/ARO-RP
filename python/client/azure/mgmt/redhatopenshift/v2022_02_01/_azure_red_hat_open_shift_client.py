...
class AzureRedHatOpenShiftClient(object):
    ...
    :vartype operations: azure.mgmt.redhatopenshift.v2022_02_01.operations.Operations
    :ivar open_shift_clusters: OpenShiftClustersOperations operations
    :vartype open_shift_clusters:
     azure.mgmt.redhatopenshift.v2022_02_01.operations.OpenShiftClustersOperations
