...
class OpenShiftClustersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either OpenShiftClusterList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2021_09_01_preview.models.OpenShiftClusterList]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.redhatopenshift.v2021_09_01_preview.models.OpenShiftCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_admin_credentials(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.list_admin_credentials.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'resourceName': self._serialize.url("resource_name", resource_name, 'str'),
