...
class OpenShiftClustersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :keyword api_version: Api Version. The default value is "2021-09-01-preview". Note that
        ...
        :return: An iterator like instance of either OpenShiftClusterList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2021_09_01_preview.models.OpenShiftClusterList]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.redhatopenshift.v2021_09_01_preview.models.OpenShiftCluster]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-09-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
