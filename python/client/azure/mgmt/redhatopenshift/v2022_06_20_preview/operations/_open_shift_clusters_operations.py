...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2022-06-20-preview")  # type: str
...
class OpenShiftClustersOperations(object):
    ...
    :type models: ~azure.mgmt.redhatopenshift.v2022_06_20_preview.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either OpenShiftClusterList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftClusterList]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftCluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftCluster
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftCluster]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-06-20-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type resource_name: str
        :param parameters: The OpenShift cluster resource.
        :type parameters: ~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftClusterUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def list_admin_credentials(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftClusterAdminKubeconfig
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_credentials(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.redhatopenshift.v2022_06_20_preview.models.OpenShiftClusterCredentials
        :raises: ~azure.core.exceptions.HttpResponseError
        """
