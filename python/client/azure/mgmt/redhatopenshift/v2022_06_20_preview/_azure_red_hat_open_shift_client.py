...
class AzureRedHatOpenShiftClient(object):
    ...
    :vartype operations: azure.mgmt.redhatopenshift.v2022_06_20_preview.operations.Operations
    :ivar open_shift_clusters: OpenShiftClustersOperations operations
    :vartype open_shift_clusters:
     azure.mgmt.redhatopenshift.v2022_06_20_preview.operations.OpenShiftClustersOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. The default value is "2022-06-20-preview". Note that
