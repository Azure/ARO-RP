...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2023-11-22")  # type: str
...
class SyncIdentityProvidersOperations(object):
    ...
    :type models: ~azure.mgmt.redhatopenshift.v2023_11_22.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either SyncIdentityProviderList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2023_11_22.models.SyncIdentityProviderList]
