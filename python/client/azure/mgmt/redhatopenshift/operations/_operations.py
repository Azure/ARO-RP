...
def build_open_shift_versions_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.RedHatOpenShift/locations/{location}/openShiftVersions/{openShiftVersion}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str"),
        "openShiftVersion": _SERIALIZER.url("open_shift_version", open_shift_version, "str"),
    }
...
def build_platform_workload_identity_role_sets_list_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.RedHatOpenShift/locations/{location}/platformWorkloadIdentityRoleSets"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str"),
    }
...
def build_open_shift_clusters_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
...
def build_open_shift_clusters_list_by_resource_group_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
    }
...
def build_open_shift_clusters_list_admin_credentials_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}/listAdminCredentials"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "resourceName": _SERIALIZER.url("resource_name", resource_name, "str"),
...
def build_open_shift_clusters_list_credentials_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}/listCredentials"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "resourceName": _SERIALIZER.url("resource_name", resource_name, "str"),
...
def build_platform_workload_identity_role_set_get_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.RedHatOpenShift/locations/{location}/platformWorkloadIdentityRoleSets/{openShiftMinorVersion}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str"),
        "openShiftMinorVersion": _SERIALIZER.url("open_shift_minor_version", open_shift_minor_version, "str"),
    }
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.redhatopenshift.RedHatOpenShiftClient`'s
...
class OpenShiftVersionsOperations:
    ...
    def get(self, location: str, open_shift_version: str, **kwargs: Any) -> _models.OpenShiftVersion:
        ...
        :return: OpenShiftVersion. The OpenShiftVersion is compatible with MutableMapping
        :rtype: ~azure.mgmt.redhatopenshift.models.OpenShiftVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.OpenShiftVersion, response.json())
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> ItemPaged["_models.OpenShiftVersion"]:
        ...
        cls: ClsType[List[_models.OpenShiftVersion]] = kwargs.pop("cls", None)
...
class PlatformWorkloadIdentityRoleSetsOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> ItemPaged["_models.PlatformWorkloadIdentityRoleSet"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.models.PlatformWorkloadIdentityRoleSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.PlatformWorkloadIdentityRoleSet]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.PlatformWorkloadIdentityRoleSet],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class OpenShiftClustersOperations:
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.OpenShiftCluster:
        ...
        :return: OpenShiftCluster. The OpenShiftCluster is compatible with MutableMapping
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.OpenShiftCluster, response.json())
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.OpenShiftCluster"]:
        ...
        cls: ClsType[List[_models.OpenShiftCluster]] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.OpenShiftCluster"]:
    ...
    def list_admin_credentials(
        ...
        :param resource_name: The name of the OpenShift cluster resource. Required.
        :type resource_name: str
        :return: OpenShiftClusterAdminKubeconfig. The OpenShiftClusterAdminKubeconfig is compatible
         with MutableMapping
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.OpenShiftClusterAdminKubeconfig, response.json())
    ...
    def list_credentials(
        ...
        :param resource_name: The name of the OpenShift cluster resource. Required.
        :type resource_name: str
        :return: OpenShiftClusterCredentials. The OpenShiftClusterCredentials is compatible with
         MutableMapping
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.OpenShiftClusterCredentials, response.json())
...
class PlatformWorkloadIdentityRoleSetOperations:  # pylint: disable=name-too-long
    ...
    def get(
        ...
        :return: PlatformWorkloadIdentityRoleSet. The PlatformWorkloadIdentityRoleSet is compatible
         with MutableMapping
        :rtype: ~azure.mgmt.redhatopenshift.models.PlatformWorkloadIdentityRoleSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.PlatformWorkloadIdentityRoleSet, response.json())
