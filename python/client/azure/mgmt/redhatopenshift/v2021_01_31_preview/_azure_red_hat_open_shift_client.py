...
class AzureRedHatOpenShiftClient(SDKClient):
    ...
    :vartype operations: azure.mgmt.redhatopenshift.v2021_01_31_preview.operations.Operations
    :ivar open_shift_clusters: OpenShiftClusters operations
    :vartype open_shift_clusters: azure.mgmt.redhatopenshift.v2021_01_31_preview.operations.OpenShiftClustersOperations
