...
class OpenShiftClustersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :keyword api_version: Api Version. The default value is "2020-04-30". Note that overriding this
        ...
        :return: An iterator like instance of either OpenShiftClusterList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2020_04_30.models.OpenShiftClusterList]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.redhatopenshift.v2020_04_30.models.OpenShiftCluster]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-04-30")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
