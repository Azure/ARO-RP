...
class SyncIdentityProvidersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either SyncIdentityProviderList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2023_09_04.models.SyncIdentityProviderList]
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.redhatopenshift.v2023_09_04.models.SyncIdentityProvider
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SyncIdentityProvider, or the result of cls(response)
        :rtype: ~azure.mgmt.redhatopenshift.v2023_09_04.models.SyncIdentityProvider
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type child_resource_name: str
        :param parameters: The SyncIdentityProvider resource.
        :type parameters: ~azure.mgmt.redhatopenshift.v2023_09_04.models.SyncIdentityProviderUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SyncIdentityProvider, or the result of cls(response)
        :rtype: ~azure.mgmt.redhatopenshift.v2023_09_04.models.SyncIdentityProvider
        :raises: ~azure.core.exceptions.HttpResponseError
