...
helps['aro validate-permissions'] = """
  type: command
  short-summary: Validate permissions required to create a cluster.
  examples:
  - name: Validate permissions.
    text: az aro validate-permissions --resource-group MyResourceGroup --vnet MyVnet --master-subnet MyMasterSubnet --worker-subnet MyWorkerSubnet
"""
