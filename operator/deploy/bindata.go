...
// sources:
// staticresources/01-namespace.yaml
// staticresources/02-serviceaccount.yaml
...
var _staticresources01NamespaceYaml = []byte("")

func staticresources01NamespaceYamlBytes() ([]byte, error) {
	return bindataRead(
		_staticresources01NamespaceYaml,
		"staticresources/01-namespace.yaml",
	)
}

func staticresources01NamespaceYaml() (*asset, error) {
	bytes, err := staticresources01NamespaceYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "staticresources/01-namespace.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _staticresources02ServiceaccountYaml = []byte("")

func staticresources02ServiceaccountYamlBytes() ([]byte, error) {
	return bindataRead(
		_staticresources02ServiceaccountYaml,
		"staticresources/02-serviceaccount.yaml",
	)
}

func staticresources02ServiceaccountYaml() (*asset, error) {
	bytes, err := staticresources02ServiceaccountYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "staticresources/02-serviceaccount.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"staticresources/01-namespace.yaml":              staticresources01NamespaceYaml,
	"staticresources/02-serviceaccount.yaml":         staticresources02ServiceaccountYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"staticresources": {nil, map[string]*bintree{
		"01-namespace.yaml":              {staticresources01NamespaceYaml, map[string]*bintree{}},
		"02-serviceaccount.yaml":         {staticresources02ServiceaccountYaml, map[string]*bintree{}},
