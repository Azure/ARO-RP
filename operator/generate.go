...
//go:generate go run ../vendor/sigs.k8s.io/controller-tools/cmd/controller-gen "crd:trivialVersions=true" rbac:roleName=aro-operator-master paths="../pkg/controllers/..." paths="apis/..."  output:dir=deploy/staticresources/master
//go:generate go run ../vendor/sigs.k8s.io/controller-tools/cmd/controller-gen "crd:trivialVersions=true" rbac:roleName=aro-operator-worker paths="../pkg/controllers/internetchecker_controller.go" output:dir=deploy/staticresources/worker
